...
def github_create_repo() -> None:
    body_json = {"name": "pylotfish", "description": "placeholder"}
...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    url_public_key = (
        ...
        "/pylotfish/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/pylotfish/actions/secrets/{secret_name}"
        )
...
def readthedocs_create() -> None:
    body_json = {
        "name": "pylotfish",
        "repository": {
            "url": "https://github.com/Stephen-RA-King" "/pylotfish",
            "type": "git",
        },
...
def readthedocs_update() -> None:
    body_json = {"name": "pylotfish", "default_branch": "main"}
...
def main() -> None:
    ...
    file_path = r"\pylotfish\Lib\site-packages\semantic_release\repository.py"
